        ...
        <div class="card bg-gray-50 border-2 border-gray-300 rounded-box px-4 py-6">
            ...
            <ul class="steps steps-vertical font-bold h-120">
                <li class="step step-info">
                    <p>
                        上の
                        <router-link to="/how_to_use"
                                     class="btn btn-ghost btn-sm bg-neutral text-white rounded-btn ml-1 top-0.5 relative">
...
export default {
    ...
    data() {
        return {
            output: '{"type": "Pro_AST","varName": "null","value": "null","child": [{"type": "Decls_AST","varName": "null","value": "null","child": [{"type": "Define_AST","varName": "null","value": "null","child": [{"type": "Ident_AST","varName": "i","value": "null","child": [],"brother": []}],"brother": [{"type": "Decls_AST","varName": "null","value": "null","child": [{"type": "Define_AST","varName": "null","value": "null","child": [{"type": "Ident_AST","varName": "sum","value": "null","child": [],"brother": []}],"brother": []}],"brother": []}]}],"brother": [{"type": "Stats_AST","varName": "null","value": "null","child": [{"type": "Assign_AST","varName": "null","value": "null","child": [{"type": "Ident_AST","varName": "sum","value": "null","child": [],"brother": [{"type": "Number_AST","varName": "null","value": "0","child": [],"brother": []}]}],"brother": [{"type": "Stats_AST","varName": "null","value": "null","child": [{"type": "Assign_AST","varName": "null","value": "null","child": [{"type": "Ident_AST","varName": "i","value": "null","child": [],"brother": [{"type": "Number_AST","varName": "null","value": "1","child": [],"brother": []}]}],"brother": [{"type": "Stats_AST","varName": "null","value": "null","child": [{"type": "While_AST","varName": "null","value": "null","child": [{"type": "Lt_AST","varName": "null","value": "null","child": [{"type": "Ident_AST","varName": "i","value": "null","child": [],"brother": [{"type": "Number_AST","varName": "null","value": "11","child": [],"brother": []}]}],"brother": [{"type": "Stats_AST","varName": "null","value": "null","child": [{"type": "Assign_AST","varName": "null","value": "null","child": [{"type": "Ident_AST","varName": "sum","value": "null","child": [],"brother": [{"type": "Add_AST","varName": "null","value": "null","child": [{"type": "Ident_AST","varName": "sum","value": "null","child": [],"brother": [{"type": "Ident_AST","varName": "i","value": "null","child": [],"brother": []}]}],"brother": []}]}],"brother": [{"type": "Stats_AST","varName": "null","value": "null","child": [{"type": "Assign_AST","varName": "null","value": "null","child": [{"type": "Ident_AST","varName": "i","value": "null","child": [],"brother": [{"type": "Add_AST","varName": "null","value": "null","child": [{"type": "Ident_AST","varName": "i","value": "null","child": [],"brother": [{"type": "Number_AST","varName": "null","value": "1","child": [],"brother": []}]}],"brother": []}]}],"brother": []}],"brother": []}]}],"brother": []}]}],"brother": []}],"brother": []}]}],"brother": []}]}],"brother": []}]}],"brother": []}',
            nodes: [],
            edges: [],
